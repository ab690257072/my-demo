<template>
	<div>
		...
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>新华社</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time | normalTime}} <span><img :src="img.zanImg" alt=""/></span></p></div>
		...
		<div class="foot-btn">
			<ul>
		    	...
		    	<li class="xing"><a href="javascript:;">
		        	<i><img :src="img.xingImg" alt=""/></i>
		        </a></li>
		    	<li class="fx"><a href="javascript:;">
		        	<i><img :src="img.fxImg" alt=""/></i>
		        </a></li>
		    </ul>
		</div>
	</div>
	...
	export default{
		...
		data(){
			return {
				articleData:{},
				img: {
					zanImg: './src/assets/zan.png',
					xingImg: './src/assets/xing.png',
					fxImg: './src/assets/fx.png'
				}
...
<style scoped>
	...
	.nav ul li{width:0.29rem;height:0.31rem; background:url(../assets/history.png) no-repeat 0 0; background-size:100%; margin:0 0 0 0.38rem;}
	...
	.say i{width:0.36rem;height:0.26rem; background:url(../assets/say.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.7rem; margin-top:0.13rem;}
	...
	.zan i{width:0.36rem;height:0.28rem; background:url(../assets/zan1.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.54rem; margin-top:0.13rem;}
