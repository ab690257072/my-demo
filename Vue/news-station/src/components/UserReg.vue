...
<style scoped>
	...
	.content .fhbtn a{ display:block;width:0.23rem;height:0.25rem; background:url(../assets/history1.png) no-repeat 0 0; background-size:100%; margin-left:0.3rem;}
	.content h1{width:2.18rem;height:1.35rem; background:url(../assets/logo.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
